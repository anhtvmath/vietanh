...
// =================================================================
// CÂU HỎI VÀ NỘI DUNG CÂU 4
// =================================================================
document.getElementById("debaiquestionTF4").innerHTML = "Nội dung đề bài câu 4"; 

// Ý thứ nhất (Bản chất là Đúng)
document.getElementById("y1cauTF4").innerHTML = "a) Nội dung ý ĐÚNG thứ nhất câu 4";
document.getElementById("y1cauTF4").setAttribute("data-ans", "Đúng");
document.getElementById("dapany1cauTF4").innerHTML = "a) Lời giải ý thứ nhất câu 4";

// Ý thứ hai (Bản chất là Đúng)
document.getElementById("y2cauTF4").innerHTML = "b) Nội dung ý ĐÚNG thứ hai câu 4";
document.getElementById("y2cauTF4").setAttribute("data-ans", "Đúng");
document.getElementById("dapany2cauTF4").innerHTML = "b) Lời giải ý thứ hai câu 4";

// Ý thứ ba (Bản chất là Đúng)
document.getElementById("y3cauTF4").innerHTML = "c) Nội dung ý ĐÚNG thứ ba câu 4";
document.getElementById("y3cauTF4").setAttribute("data-ans", "Đúng");
document.getElementById("dapany3cauTF4").innerHTML = "c) Lời giải ý thứ ba câu 4";

// Ý thứ tư (Bản chất là Sai)
document.getElementById("y4cauTF4").innerHTML = "d) Nội dung ý SAI thứ tư câu 4";
document.getElementById("y4cauTF4").setAttribute("data-ans", "Sai");
document.getElementById("dapany4cauTF4").innerHTML = "d) Lời giải ý thứ tư câu 4";