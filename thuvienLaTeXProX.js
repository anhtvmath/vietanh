function dothibacba_a_am(a, b, c, d) {
    ...
    if (a === -1 && b === 0 && c === 3) {
        var conf1 = {
            "-2": { yMin: -4.5, yMax: 0.8, dom: "1.95", nO: "below left",  n1: "above", n2: "above", yNodes: "\\draw (0,-4) node[right]{$-4$} circle (1pt);", d1: "(-1,-4) -- (0,-4)", d2: "(1,0) -- (0,0)" },
            "-1": { yMin: -3.5, yMax: 1.5, dom: "1.98", nO: "below left",  n1: "above", n2: "below", yNodes: "\\draw (0,-3) node[right]{$-3$} circle (1pt);\n\\draw (0,1) node[left]{$1$} circle (1pt);", d1: "(-1,-3) -- (0,-3)", d2: "(1,1) -- (0,1)" },
            "0":  { yMin: -2.5, yMax: 2.5, dom: "2.05", nO: "below left",  n1: "above", n2: "below", yNodes: "\\draw (0,-2) node[right]{$-2$} circle (1pt);\n\\draw (0,2) node[left]{$2$} circle (1pt);", d1: "(-1,-2) -- (0,-2)", d2: "(1,2) -- (0,2)" },
            "1":  { yMin: -1.5, yMax: 3.5, dom: "2.08", nO: "below right", n1: "above", n2: "below", yNodes: "\\draw (0,-1) node[right]{$-1$} circle (1pt);\n\\draw (0,3) node[left]{$3$} circle (1pt);", d1: "(-1,-1) -- (0,-1)", d2: "(1,3) -- (0,3)" },
            "2":  { yMin: -0.8, yMax: 4.5, dom: "2.12", nO: "below left",  n1: "below", n2: "below", yNodes: "\\draw (0,4) node[left]{$4$} circle (1pt);", d1: "-1,0) -- (0,0)", d2: "(1,4) -- (0,4)" }
        };
        var c1 = conf1[d];
        if (c1) {
            result = "$$\\begin{tikzpicture}[>=stealth,thick,scale=0.9]\n" +
                "\\draw[->,>=stealth, line width = 1pt] (-2.3,0)--node[below, pos = 0.98]{$x$}(2.3,0);\n" +
                ...
                "\\draw[thick,samples=200,domain=-" + c1.dom + ":" + c1.dom + "] plot(\\x,{-(\\x)^3+3*(\\x)" + (d >= 0 ? (d === 0 ? "" : "+" + d) : d) + "});\n" +
                "\\end{tikzpicture}$$";
        }
    }
    ...
    // BỘ 2: y = -x^3 + 3x^2 + d
        ...
        var conf2 = {
            "-4": { yMin: -4.3, yMax: 0.8, domL: -0.6, domR: 3.0, nO: "below left", yNodes: "\\draw (0,-4) node[below left]{$-4$} circle (1pt);", dash: "(2,0) -- (0,0)" },
            "-3": { yMin: -3.3, yMax: 1.8, domL: -0.7, domR: 3.0, nO: "below left", yNodes: "\\draw (0,-3) node[below left]{$-3$} circle (1pt);\n\\draw (0,1) node[left]{$1$} circle (1pt);", dash: "(2,1) -- (0,1)" },
            "-2": { yMin: -2.3, yMax: 2.8, domL: -0.8, domR: 3.0, nO: "below left", yNodes: "\\draw (0,-2) node[below left]{$-2$} circle (1pt);\n\\draw (0,2) node[left]{$2$} circle (1pt);", dash: "(2,2) -- (0,2)" },
            "-1": { yMin: -1.3, yMax: 3.8, domL: -0.9, domR: 3.0, nO: "above right", yNodes: "\\draw (0,-1) node[below left]{$-1$} circle (1pt);\n\\draw (0,3) node[left]{$3$} circle (1pt);", dash: "(2,3) -- (0,3)" },
            "0":  { yMin: -0.8, yMax: 4.5, domL: -1.0, domR: 3.1, nO: "below left",  yNodes: "\\draw (0,4) node[left]{$4$} circle (1pt);", dash: "(2,4) -- (0,4)" },
            "1":  { yMin: -0.5, yMax: 5.5, domL: -1.0, domR: 3.2, nO: "below left",  yNodes: "\\draw (0,1) node[below left]{$1$} circle (1pt);\n\\draw (0,5) node[left]{$5$} circle (1pt);", dash: "(2,5) -- (0,5)" },
            "2":  { yMin: -0.3, yMax: 6.5, domL: -1.1, domR: 3.3, nO: "below left",  yNodes: "\\draw (0,2) node[below left]{$2$} circle (1pt);\n\\draw (0,6) node[left]{$6$} circle (1pt);", dash: "(2,6) -- (0,6)" }
        };
        var c2 = conf2[d];
        if (c2) {
            result = "$$\\begin{tikzpicture}[>=stealth,thick,scale=0.9]\n" +
                "\\draw[->,>=stealth, line width = 1pt] (-1.4,0)--node[below, pos = 0.98]{$x$}(3.5,0);\n" +
                ...
                "\\draw[thick,samples=200,domain=" + c2.domL + ":" + c2.domR + "] plot(\\x,{-(\\x)^3+3*(\\x)^2" + (d >= 0 ? (d === 0 ? "" : "+" + d) : d) + "});\n" +
                "\\end{tikzpicture}$$";
        }
    }
    ...
    // BỘ 3: y = -x^3 - 3x^2 + d
        ...
        var conf3 = {
            "-2": { yMin: -6.5, yMax: 0.5, domL: -3.1, domR: 0.8, nO: "above right", n2B: "above", yNodes: "\\draw (0,-2) node[above right]{$-2$} circle (1pt);\n\\draw (0,-6) node[right]{$-6$} circle (1pt);", d1: "(-2,-6) -- (0,-6)" },
            "-1": { yMin: -5.5, yMax: 0.8, domL: -3.1, domR: 0.8, nO: "above right", n2B: "above", yNodes: "\\draw (0,-1) node[above right]{$-1$} circle (1pt);\n\\draw (0,-5) node[right]{$-5$} circle (1pt);", d1: "(-2,-5) -- (0,-5)" },
            "0":  { yMin: -4.5, yMax: 1.0, domL: -3.0, domR: 0.9, nO: "above right", n2B: "above", yNodes: "\\draw (0,-4) node[right]{$-4$} circle (1pt);", d1: "(-2,-4) -- (0,-4)" },
            "1":  { yMin: -3.5, yMax: 1.8, domL: -3.0, domR: 1.0, nO: "below left",  n2B: "above", yNodes: "\\draw (0,1) node[above right]{$1$} circle (1pt);\n\\draw (0,-3) node[right]{$-3$} circle (1pt);", d1: "(-2,-3) -- (0,-3)" },
            "2":  { yMin: -2.5, yMax: 2.8, domL: -3.0, domR: 1.1, nO: "above right", n2B: "above", yNodes: "\\draw (0,2) node[above right]{$2$} circle (1pt);\n\\draw (0,-2) node[right]{$-2$} circle (1pt);", d1: "(-2,-2) -- (0,-2)" },
            "3":  { yMin: -1.5, yMax: 3.8, domL: -3.0, domR: 1.2, nO: "above right", n2B: "above", yNodes: "\\draw (0,3) node[above right]{$3$} circle (1pt);\n\\draw (0,-1) node[right]{$-1$} circle (1pt);", d1: "(-2,-1) -- (0,-1)" },
            "4":  { yMin: -0.5, yMax: 4.5, domL: -3.0, domR: 1.3, nO: "above right", n2B: "below", yNodes: "\\draw (0,4) node[above right]{$4$} circle (1pt);", d1: "(-2,0) -- (0,0)" }
        };
        var c3 = conf3[d];
        if (c3) {
            result = "$$\\begin{tikzpicture}[>=stealth,thick,scale=0.9]\n" +
                "\\draw[->,>=stealth, line width = 1pt] (-3.4,0)--node[below, pos = 0.98]{$x$}(1.5,0);\n" +
                ...
                "\\draw[thick,samples=200,domain=" + c3.domL + ":" + c3.domR + "] plot(\\x,{-(\\x)^3-3*(\\x)^2" + (d >= 0 ? (d === 0 ? "" : "+" + d) : d) + "});\n" +
                "\\end{tikzpicture}$$";
        }
    }
